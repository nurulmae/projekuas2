...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="assets/images/product/logora.png" type="image/png">
...
<body>
                ...
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href="index.html">
                            <img src="assets/images/product/fashion/logora.png" alt="Logo" width="50px"> 
                        </a> <!-- Logo -->
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item">
                                    <a data-scroll-nav="0" href="{{ url('/home') }}">Login</a>
                                </li>
                            </ul> <!-- navbar nav -->
                        </div>
                    </nav> <!-- navbar -->
                        ...
                        <div class="row no-gutters align-items-center ">
                            <div class="col-lg-4 col-md-5">
                                <div class="slider-product-image d-none d-md-block">
                                    <img src="assets/images/slider/fashion/c1.jpg" alt="Slider">
                            ...
                            <div class="col-lg-8 col-md-7">
                                <div class="slider-product-content">
                                    <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s"><span>Welcome</span> to<span>Fashion World!</span></h1>
                                    <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">"Fashion adalah seni hidup. Setiap hari adalah panggung, dan pakaianmu adalah kostummu." - Carolina Herrera <br> This Raratyax World</p>
                ...
                <div class="single-slider">
                        <div class="slider-bg">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-4 col-md-5">
                                    <div class="slider-product-image d-none d-md-block">
                                        <img src="assets/images/slider/fashion/c2.jpg" alt="Slider">
                                        <div class="slider-discount-tag">
                                            <p>-50% <br> OFF</p>
                                        </div>
                                    </div> <!-- slider product image -->
                                ...
                                <div class="col-lg-8 col-md-7">
                                    <div class="slider-product-content">
                                        <h1 class="slider-title mb-10" data-animation="fadeInUp" data-delay="0.3s"><span>Summer</span> Sale! is <span>Here</span></h1>
                                        <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">"Fashion adalah pernyataan tentang siapa kita dan bagaimana kita ingin dilihat. Jadilah pernyataan yang kuat dan tak terlupakan." - Sunoo Chi <br> This Fashion World</p>
                ...
                <div class="single-slider">
                        <div class="slider-bg">
                            <div class="row no-gutters align-items-center">
                                <div class="col-lg-4 col-md-5">
                                    <div class="slider-product-image d-none d-md-block">
                                        <img src="assets/images/slider/fashion/c3.jpg" alt="Slider">
                                        <div class="slider-discount-tag">
                                            <p>-20%<br> OFF</p>
                                        </div>
                                    </div> <!-- slider product image -->
                                ...
                                <div class="col-lg-8 col-md-7">
                                    <div class="slider-product-content">
                                        ...
                                        <p class="mb-25" data-animation="fadeInUp" data-delay="0.9s">"Tidak ada aturan dalam fashion. Jadilah dirimu sendiri, bereksperimen, dan nikmati perjalananmu dalam menemukan gaya pribadimu." - Evelyn Hwang<br> This Fashion World</p>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        <div class="product-image">
                            <img src="assets/images/product/fashion/bg3.jpg" alt="Product">
                        </div> <!-- product image -->
                        <div class="product-content">
                            <h4 class="content-title mb-15">High-quality fashion <br> For your home</h4>
                ...
                <div class="col-lg-6">
                    <div class="single-discount-product mt-30">
                        <div class="product-image">
                            <img src="assets/images/product/fashion/bg8.jpg" alt="Product">
                        </div> <!-- product image -->
                        <div class="product-content">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <div class="collection-menu text-center mt-30">
                        <h4 class="collection-tilte">BEST SELLING</h4>
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            <a class="active" id="v-pills-furniture-tab" data-toggle="pill" href="#v-pills-furniture" role="tab" aria-controls="v-pills-furniture" aria-selected="true">Tas</a>
                            
                            <a id="v-pills-decorative-tab" data-toggle="pill" href="#v-pills-decorative" role="tab" aria-controls="v-pills-decorative" aria-selected="false">Make Up</a>
                            
                            <a id="v-pills-lighting-tab" data-toggle="pill" href="#v-pills-lighting" role="tab" aria-controls="v-pills-lighting" aria-selected="false">Parfum</a>
                            ...
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="assets/images/product/fashion/g1.png" alt="Product"></a>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="assets/images/product/fashion/g2.png" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-30%</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="assets/images/product/fashion/g4.png" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-10%</p>
                                                </div>
                                            </div>
                            ...
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="assets/images/product/fashion/m1.jpg" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>25%</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="assets/images/product/fashion/m2.jpg" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-60%</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="assets/images/product/fashion/m3.jpg" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-10%</p>
                                                </div>
                                            </div>
                            ...
                            <div class="product-items mt-30">
                                <div class="row product-items-active">
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="assets/images/product/fashion/p1.jpg" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-15%</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="assets/images/product/fashion/p2.jpg" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-40%</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="single-product-items">
                                            <div class="product-item-image">
                                                <a href="#"><img src="assets/images/product/fashion/3.jpg" alt="Product"></a>
                                                <div class="product-discount-tag">
                                                    <p>-60%</p>
                                                </div>
                                            </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-30">
                        <h5 class="mb-15">Our Fashion</h5>
                        <h3 class="title mb-15">How To Order</h3>
                        <p>Berikut ini adalah langkah-langkah untuk melakukan  </p>
                    </div> <!-- section title -->
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6">
                    <div class="services-left mt-45">
                        <div class="services">
                            <img src="assets/images/product/fashion/bg5.jpg" alt="">
                            ...
                            <div class="col-md-6 col-sm-8">
                                <div class="single-services text-center">
                                    ...
                                    <div class="services-content mt-20">
                                        <h5 class="title mb-10">Login To Site</h5>
                                ...
                                <div class="single-services text-center mt-30">
                                    ...
                                    <div class="services-content mt-20">
                                        <h5 class="title mb-10">Choose Product</h5>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusm od tempor.</p>
                                    </div>
                                </div> <!-- single services -->
                            </div>
    ...
    <section id="testimonial" class="testimonial-area pt-200">
        <div class="testimonial-bg bg_cover" style="background-image: url(assets/images/product/fashion/bg.png)"></div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="testimonial-content">
                        <div class="testimonial-active">
                            <div class="single-testimonial">
                                ...
                                <p class="mb-30">Pakaian menjadi kanvas ekspresi diri saya, memungkinkan saya untuk mengekspresikan kreativitas, kepribadian saya dengan cara yang unik.</p>
                                <h6 class="title">Roma Kelava </h6>
                                <span>- CEO, Astra</span>
                            </div> <!-- single testimonial -->
                            <div class="single-testimonial">
                                <i class="lni-quotation"></i>
                                <p class="mb-30">Saya menemukan keindahan dalam setiap pakaian, warna, dan aksesori untuk menciptakan tampilan yang mencerminkan siapa saya sebenarnya</p>
                                <h6 class="title">Catharina Liu</h6>
                                <span>- Designer, Bulbul</span>
                            </div> <!-- single testimonial -->
                ...
                <div class="col-lg-7 col-md-4">
                    <div class="testimonial-play text-right d-none d-md-block">
                        <a class="Video-popup" href="https://www.youtube.com/embed/CJsZTiYnRgI"><i class="lni-play"></i></a>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-5 col-sm-7">
                        <div class="footer-logo mt-40">
                            ...
                            Fashion World
                            <p class="mt-10">Fashion adalah pernyataan tentang siapa kita dan bagaimana kita ingin dilihat.</p>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-5">
                        <div class="footer-link mt-50">
                            ...
                            <ul>
                                <li><a href="#">Architechture Fashion</a></li>
                                <li><a href="#">Best Fashion</a></li>
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="single-footer-info mt-20">
                                        <span>Address :</span>
                                        <div class="footer-info-content">
                                            <p>Jl. Sayaga Blok F2 No 9 Sukahati, Cibinong</p>
                                        </div>
                                    </div> <!-- single footer info -->
                                </li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="copyright text-center">
                            <p>Developed by <a href="https://uideck.com" rel="nofollow">Tyx Raa</a></p>
                        </div> <!-- copyright -->
                    </div>
                </div> <!-- row -->
